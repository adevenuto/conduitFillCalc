...
export const WireIcon = ({ type, size = 20 }) => {
...
export const ConduitIcon = ({ type, size = 20 }) => {
  const getConduitStyle = (conduitType) => {
    const styles = {
      // Metal Conduits
      'EMT': {
    ...
    return styles[conduitType] || styles['EMT'];
  };
